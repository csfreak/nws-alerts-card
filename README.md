...
| ----------------- | ------- | ------------ | ------------------------------------------- | ------------------- |
| type              | string  | **Required** | `custom:nws-alerts-card`                   |
| name              | string  | **Optional** | Card name                                   | `NWSAlerts`       |
...
## Starting a new card from nws-alerts-card
...
## Starting a new card from nws-alerts-card with [devcontainer][devcontainer]
...
3. The compiled `.js` file will be accessible on
   `http://127.0.0.1:5000/nws-alerts-card.js`.
4. On a running Home Assistant installation add this to your Lovelace
   `resources:`

```yaml
- url: 'http://127.0.0.1:5000/nws-alerts-card.js'
  type: module
```
